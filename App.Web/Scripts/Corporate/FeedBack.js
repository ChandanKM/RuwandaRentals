    ...
    self.Submit = function (data) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                var sub = 'Feedback form has been successfully submitted';
                ...
                var result = { Status: true, ReturnMessage: { ReturnMessage: "Thanks for the Feedback!!" }, ErrorType: "Success" };
                Successed(result);
               // Successed(response);
                OnSuccessSubmit();
