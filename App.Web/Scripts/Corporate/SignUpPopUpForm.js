...
ko.applyBindings(signupVM, document.getElementById('signupPopUpForm'));
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.Table[0].Result == 0) {
                    ...
                    var result = { Status: true, ReturnMessage: { ReturnMessage: 'You are registered allready!!' }, ErrorType: "Success" };
                    Successed(result);
